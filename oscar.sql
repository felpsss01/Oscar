...
select * from movies where name = "Natalie Portman"; /* a Natalie Portman foi indicada 3 vezes ao Oscar. */

/* 2- Quantos Oscars Natalie Portman ganhou? */

 select * from movies where winner = "Natalie Portman";  /* a Natalie Portman ganhou 0 Oscar em sua carreira. */

 /* 3- Amy Adams já ganhou algum Oscar? */

select * from movies where name = "Amy Adams";  /* e  */    select * from movies where name = "Amy Adams" and winner = 1; /* Amy Adams não ganhou nenhum Oscar em sua carreira. */

/* 4- A série de filmes Toy Story ganhou um Oscar em quais anos? */

select * from movies where film = "Toy Story"and category and winner = 1; /* A série de films Toy Story nao ganhou nenhum Oscar. */
...
/* 12- Crie uma nova categoria de premiação. Qualquer prêmio que você queira dar. Agora vamos dar esses prêmios aos filmes que você cadastrou na questão acima.*/
 ...
 alter table movies add melhores_comedia varchar(190);
...
select year_ceremony, category,film , name, winner from movies
...
para inserir o valor dessa pergunta e usado o comando  */
